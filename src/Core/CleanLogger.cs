...
public static class CleanLogger
{
    ...
    /// <summary>
    /// Deletes every log file in the log directory.
    ...
    public static int DeleteAll()
    {
        ...
        try
        {
            ...
            foreach (var file in new DirectoryInfo(LogDirectory).GetFiles("clean-*.log"))
            {
                try
                {
                    file.Delete();
        ...
        {
            // Directory may have disappeared between the check and the enumeration.
        }
