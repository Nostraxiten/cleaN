...
| **Report and logs** | A plain text log of every run: each file removed and the total space recovered |
...
- **Temporary files younger than 24 hours are left alone**, because running installers keep
  live state there.
- **Every run is logged**, so you can always audit what happened.
